...
.sps-launch__text2 {
  color: var(--sjs2-color-fg-basic-secondary, rgba(28, 27, 32, 0.6));
  text-align: left;
  font-family: var(--sjs2-typography-small-font-family, "OpenSans-Regular", sans-serif);
  font-size: var(--sjs2-typography-small-font-size, 12px);
  line-height: var(--sjs2-typography-small-line-height, 16px);
  font-weight: var(--sjs2-typography-small-font-weight, 400);
  position: relative;
  text-overflow: ellipsis;
  overflow: hidden;
...
.sps-launch__chevron-right-16-x-16 {
  flex-shrink: 0;
  width: 24px;
  height: 24px;
  position: relative;
...
.sps-launch__icon2 use {
  fill: var(--sjs2-color-fg-basic-primary-muted, #424146);
}

.sps-launch__chevron-down {
  align-self: stretch;
  flex: 1;
  height: auto;
  position: relative;
...
.sps-list__item--positive .sps-list__item-body {
  color: var(--sjs2-color-fg-brand-primary, #19b394);
}

.sps-list__item--alert .sps-list__item-body {
  color: var(--sjs2-color-fg-alert-primary, #C30935);
}
...
.sps-list__item-body > span, .sps-list__item-body > sv-ng-string {
  flex: 1 0 0;
}
...
.sps-list__item--label .sps-list__item-body {
  display: flex;
  ...
  overflow: hidden;
  color: var(--sjs2-color-fg-basic-tertiary, rgba(28, 27, 32, 0.4));
  /* sjs2/typography/small-strong */
  font-family: var(--sjs2-typography-font-family-default, "Open Sans");
  font-size: var(--sjs2-typography-font-size-small, 12px);
  font-style: normal;
  font-weight: 600;
  line-height: var(--sjs2-typography-line-height-small, 16px); /* 133.333% */
}
.sps-list__item--label {
  padding-bottom: var(--sjs2-spacing-x050, 4px);
}

.sps-list__item--group .sps-list__item-body {
  padding-right: 0;
}

.sps-list__item:focus > .sps-list__item-body,
.sps-list__item:hover > .sps-list__item-body,
.sps-list__item--focused > .sps-list__item-body,
.sps-list__item--hovered > .sps-list__item-body {
  background: var(--sjs2-color-bg-brand-tertiary-dim, rgba(25, 179, 148, 0.1));
}

.sps-list__item--alert:focus > .sps-list__item-body,
.sps-list__item--alert:hover > .sps-list__item-body {
  background: var(--sjs2-color-bg-alert-tertiary-dim, rgba(229, 10, 62, 0.1));
}

.sps-list__item--selected > .sps-list__item-body,
.sps-list__item--selected:hover > .sps-list__item-body,
.sps-list__item--selected:focus > .sps-list__item-body,
.sps-list__item.sps-list__item--selected:hover > .sps-list__item-body {
  /* sjs2/typography/default-strong */
  font-family: var(--sjs2-font-family-semantic-default, "Open Sans");
  font-size: var(--sjs2-font-size-semantic-default, 16px);
  font-style: normal;
...
.sps-list-item__marker-icon use {
  fill: currentColor;
}
...
.sps-popup-menu.sv-popup--menu-popup.sps-popup-menu--always-on-top {
  height: unset;
}
.sps-popup-menu.sv-popup--menu-popup .sv-popup__container {
  border: initial;
  padding: var(--sjs2-spacing-x150, 12px);
  box-shadow: initial;
  background: initial;
...
.sps-popup-menu.sv-popup--menu-popup .sv-popup__container .sv-popup__body-content {
...
.sps-popup-menu.sps-popup-menu--dropdown .sv-popup__container {
  padding-top: var(--sjs2-spacing-x50, 4px);
}

.sps-popup-menu.sps-popup-menu--context .sv-popup__container {
...
.sps-navigation-bar-item:hover, .sps-navigation-bar-item:focus-visible {
  background: var(--sjs2-color-bg-basic-primary-dim, #f5f5f5);
}
.sps-navigation-bar-item:active, .sps-navigation-bar-item.sps-navigation-bar-item--pressed {
  background: var(--sjs2-color-bg-basic-primary, #fff);
}
.sps-navigation-bar-item.sps-navigation-bar-item--active {
  background: var(--sjs2-color-bg-basic-primary-dim, #f5f5f5);
}
.sps-navigation-bar-item:disabled {
  opacity: var(--sjs2-opacity-disabled, 0.25);
  background: var(--sjs2-color-bg-basic-primary-disabled, #d4d4d4);
}
...
.sps-navigation-bar-item__title {
  display: flex;
...
.sps-navigation-action--large-icon .sps-navigation-bar-item__icon {
  display: flex;
  padding: var(--sjs2-layout-control-action-small-icon-vertical, 0) var(--sjs2-layout-control-action-small-icon-horizontal, 0);
  align-items: center;
}
...
.sps-page__title {
  color: var(--sjs2-color-fg-basic-primary, #1c1b20);
  /* sjs2/typography/medium-strong */
  font-family: var(--sjs2-font-family-semantic-default, "Open Sans");
  font-size: var(--sjs2-font-size-semantic-medium, 24px);
  font-style: normal;
  font-weight: 600;
  line-height: var(--sjs2-line-height-semantic-medium, 32px); /* 133.333% */
}
...
.sps-action-title-bar .sv-action--hidden {
  display: none;
}
...
.sps-question[data-name=json] .sps-question__content,
.sps-question[data-name=json] sv-ng-question-comment {
  flex-grow: 1;
  display: flex;
  flex-direction: column;
}
.sps-question[data-name=json] .sps-comment {
  flex-grow: 1;
}
